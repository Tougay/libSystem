    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="borrow.php"><i class="fa fa-circle-o"></i> Emprunter</a></li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="category.php"><i class="fa fa-circle-o"></i> Categorie</a></li>
        </ul>
      </li>
      <li class="treeview">
        <a href="#">
        ...
        <ul class="treeview-menu">
          <li><a href="student.php"><i class="fa fa-circle-o"></i> Liste des étudiants</a></li>
