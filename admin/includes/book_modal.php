    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Ajouter un nouveau livre</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="author" class="col-sm-3 control-label">Autheur</label>
                ...
                <div class="form-group">
                    <label for="publisher" class="col-sm-3 control-label">Éditeur</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              		<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Modifier le livre</b></h4>
          	</div>
          	<div class="modal-body">
